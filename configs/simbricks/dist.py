...
def makeX86System(mem_mode, numCPUs=1, mdesc=None, workload=None, Ruby=False) :
    ...
    class SimBricksPc(Pc):
        ...
        def add_dist_e1000_eth(self, params):
            print('adding dist eth:', params)

            ethif = DistEtherLink(speed = params.ethernet_linkspeed,
                                   delay = params.ethernet_linkdelay,
                                   dist_rank = params.dist_rank,
                                   dist_size = params.dist_size,
                                   server_name = params.dist_server_name,
                                   server_port = params.dist_server_port,
                                   sync_start = params.dist_sync_start,
                                   sync_repeat = params.dist_sync_repeat)
    ...
    if options.dist:
        self.pc.add_dist_e1000_eth(options)
